...
if ((Test-Path "sim_build/simple_cpu_wishbone_tb.vcd") -and (-not $NoWaves)) {
    Write-Host "Waveform written to sim_build/simple_cpu_wishbone_tb.vcd"
}

if (Test-Path "sim_build/wishbone_coverage.json") {
    Write-Host "Wishbone coverage JSON: sim_build/wishbone_coverage.json"
}

if (Test-Path "sim_build/wishbone_coverage.csv") {
    Write-Host "Wishbone coverage CSV:  sim_build/wishbone_coverage.csv"
}

Write-Host "Wishbone simulation complete."
