...
module simple_cpu_mmio_tb;
        ...
        begin
            for (idx = 0; idx < 16; idx = idx + 1) begin
                ...
                if (observed !== program_mem[idx]) begin
                    $fatal(1, "MMIO shadow mismatch at imem[%0d]: got %0h expected %0h", idx, observed, program_mem[idx]);
                end
            end
        end
    endtask
    ...
    task automatic report_and_check_mmio_coverage;
        ...
        begin
            ...
            $display("[MMIO-COVERAGE] wrote sim_build/mmio_coverage.json and sim_build/mmio_coverage.csv");
