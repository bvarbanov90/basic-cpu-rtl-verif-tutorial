...
Generated UTC: `2026-04-27T19:22:08Z`

| Field | Value |
|---|---|
| Label | axi-lite-formal-fault-regression |
| Git branch | `main` |
| Git commit | `533ba4e` |
| Git dirty | `1` |
...
| simple_cpu_mmio | `PASS` | `cvc5` | `0:01:09` | `formal/simple_cpu_mmio` |
...
| simple_cpu_axi_lite | `PASS` | `cvc5` | `0:00:00` | `formal/simple_cpu_axi_lite` |
...
| simple_cpu_axi_lite_faults | `PASS` | `cvc5` | `0:00:00` | `formal/simple_cpu_axi_lite_faults` |
...
| simple_cpu_axi_lite_cover | `PASS` | `cvc5` | `0:00:00` | `formal/simple_cpu_axi_lite_cover` |

## Latest Coverage History Snapshot

| Field | Value |
|---|---|
| Timestamp UTC | `2026-04-14T18:12:20Z` |
...
1. `docs/status/badges/formal-simple_cpu_axi_lite.json`
1. `docs/status/badges/formal-simple_cpu_axi_lite_cover.json`
1. `docs/status/badges/formal-simple_cpu_axi_lite_faults.json`
