...
Generated UTC: `2026-04-11T12:52:03Z`
...
| formal | yes | `PASS` | simple_cpu:PASS solver=cvc5 elapsed=0:00:03; simple_cpu_mmio:PASS solver=cvc5 elapsed=0:01:09; simple_cpu_cover:PASS solver=cvc5 elapsed=0:00:00; simple_cpu_mmio_cover:PASS solver=cvc5 elapsed=0:00:02 | `-` |
...
| cocotb_verilator | no | `PASS` | tests=5, failures=0, errors=0, skipped=0 | `sim_build/verilator_results.xml` |
...
| Field | Value |
|---|---|
| Timestamp UTC | `2026-04-11T12:51:54Z` |
| Label | tutorial-regression |
| Commit | `ba3f314` |
| Dirty | `0` |
