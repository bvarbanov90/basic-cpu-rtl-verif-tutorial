...
Generated UTC: `2026-04-12T20:38:44Z`
...
| simple_cpu_mmio | `PASS` | `cvc5` | `0:01:08` | `formal/simple_cpu_mmio` |
...
| Field | Value |
|---|---|
| Timestamp UTC | `2026-04-12T20:38:36Z` |
| Label | tutorial-regression |
| Commit | `b41f78a` |
| Dirty | `0` |
